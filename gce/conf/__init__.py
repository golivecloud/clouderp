...
For now, configuration code is in gce.tools.config. It is in mainly
...
To initialize properly this module, gce.tools.config.parse_config()
must be used.
...
# Paths to search for gce addons.
addons_paths = []
...
# installed (i.e. the majority of gce addons). This is set with the --load
# command-line option.
server_wide_modules = []
