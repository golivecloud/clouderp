...
description = 'clouderp Server'
long_desc = '''clouderp is a complete ERP and CRM. The main features are accounting (analytic
...
"""
url = 'https://www.golive.pt'
author = 'gce S.A.'
author_email = 'info@golive.pt'
license = 'LGPL-3'

nt_service_name = "clouderp-server-" + series
