...
import gce.osv.orm
import gce.osv.osv
import gce.tools.safe_eval
from gce.exceptions import UserError
from gce.exceptions import except_orm

class m(gce.osv.osv.Model):
    ...
    def generate_except_osv(self, cr, uid, ids, context=None):
        ...
        raise gce.osv.osv.except_osv('title', 'description')
    ...
    def generate_warning(self, cr, uid, ids, context=None):
        raise gce.exceptions.Warning('description')
    ...
    def generate_redirect_warning(self, cr, uid, ids, context=None):
        ...
        raise gce.exceptions.RedirectWarning('description', action_id, 'Go to the redirection')
    ...
    def generate_access_error(self, cr, uid, ids, context=None):
        raise gce.exceptions.AccessError('description')
    ...
    def generate_missing_error(self, cr, uid, ids, context=None):
        raise gce.exceptions.MissingError('description')

    def generate_validation_error(self, cr, uid, ids, context=None):
        raise gce.exceptions.ValidationError('description')
    ...
    def generate_safe_eval(self, cr, uid, ids, f, context):
        ...
        gce.tools.safe_eval.safe_eval("generate()", mode='exec', globals_dict=globals_dict)
