...
from gce.tests.common import TransactionCase
...
class TestAssetsBundleWithIRAMock(TransactionCase):
    def setUp(self):
        ...
        self.patcher1 = patch('gce.addons.base.ir.ir_attachment.ir_attachment.create', wraps=self.registry['ir.attachment'].create)
        self.patcher2 = patch('gce.addons.base.ir.ir_attachment.ir_attachment.unlink', wraps=self.registry['ir.attachment'].unlink)
