...
import gce.tests.common as common
...
workflow"""
    ...
    def test_20_trigger(self):
        ...
        # Clear workflow cache, otherwise gce will try to create workflows even if it has been deleted
        from gce.workflow import clear_cache
        clear_cache(cr, uid)
