...
#    > gce_ADDONS_PATH='../../addons/trunk' gce_PORT=8069 \
#      gce_DATABASE=yy PYTHONPATH=. python tests/test_ir_sequence.py
#    > gce_ADDONS_PATH='../../addons/trunk' gce_PORT=8069 \
#      gce_DATABASE=yy nosetests tests/test_ir_sequence.py
#    > gce_ADDONS_PATH='../../../addons/trunk' gce_PORT=8069 \
#      gce_DATABASE=yy PYTHONPATH=../:. unit2 test_ir_sequence
...
def registry(model):
    return gce.modules.registry.RegistryManager.get(common.get_db_name())[model]

def cursor():
    return gce.modules.registry.RegistryManager.get(common.get_db_name()).cursor()
