...
from gce.tools import float_round, float_is_zero, float_compare
import json
...
class res_currency(osv.osv):
    ...
    def get_format_currencies_js_function(self, cr, uid, context=None):
        ...
        for row in self.search_read(cr, uid, domain=[], fields=['id', 'name', 'symbol', 'decimal_places', 'position'], context=context):
            ...
            format_number_str = "gce.web.format_value(arguments[0], {type: 'float', digits: [69," + str(row['decimal_places']) + "]}, 0.00)"
