    ...
    def _get_address_data(self, cr, uid, ids, field_names, arg, context=None):
        ...
        for company in self.browse(cr, uid, ids, context=context):
            ...
            if company.partner_id:
                address_data = part_obj.address_get(cr, gce.SUPERUSER_ID, [company.partner_id.id], adr_pref=['contact'])
                if address_data['contact']:
                    address = part_obj.read(cr, gce.SUPERUSER_ID, [address_data['contact']], field_names, context=context)[0]
...
<header>
    <pageTemplate>
        ...
        <pageGraphics>
            ...
            <rotate degrees="90"/>
            <fill color="grey"/>
            <drawString x="2.65cm" y="-0.4cm">generated by golive.pt</drawString>
            <fill color="black"/>
            <rotate degrees="-90"/>
