...
class ir_ui_menu(osv.osv):
    ...
    def read_image(self, path):
        ...
        icon_path = gce.modules.get_module_resource(path_info[0],path_info[1])
        icon_image = False
        if icon_path:
            try:
    ...
    _columns = {
        ...
        'groups_id': fields.many2many('res.groups', 'ir_ui_menu_group_rel',
            'menu_id', 'gid', 'Groups', help="If you have groups, the visibility of this menu will be based on these groups. "\
                "If this field is empty, clouderp will compute visibility based on the related object's read access."),
    ...
    web_icon_data = gce.fields.Binary('Web Icon Image',
