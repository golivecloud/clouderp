...
import gce
from gce import tools, api
from gce.exceptions import ValidationError
from gce.http import request
from gce.modules.module import get_resource_path, get_resource_from_path
from gce.osv import fields, osv, orm
from gce.tools import config, graph, SKIPPED_ELEMENT_TYPES, SKIPPED_ELEMENTS
from gce.tools.convert import _fix_multiple_roots
from gce.tools.parse_version import parse_version
from gce.tools.safe_eval import safe_eval as eval
from gce.tools.view_validation import valid_view
from gce.tools import misc
from gce.tools.translate import TRANSLATED_ATTRS, encode, xml_translate, _
...
* if False, the view currently does not extend its parent but can be enabled
    ...
    def render(self, cr, uid, id_or_xml_id, values=None, engine='ir.qweb', context=None):
        ...
        def get_modules_order():
            if request:
                from gce.addons.web.controllers.main import module_boot
