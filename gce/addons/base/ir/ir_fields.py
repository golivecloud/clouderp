...
from gce import models, fields, api, _
from gce.tools import DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, ustr
...
class ir_fields_converter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an gce
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`gce.osv.orm.Model.write` expects.

        :param model: :class:`gce.osv.orm.Model` for the conversion base
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`gce.fields.Field`
        :param fromtype: type to convert to something fitting for ``field``
        :type fromtype: type | str
        :param context: gce request context
