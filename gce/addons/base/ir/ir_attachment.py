...
from gce import SUPERUSER_ID, tools
from gce.exceptions import AccessError
from gce.osv import fields,osv
from gce.tools.translate import _
from gce.tools.misc import ustr, html_escape
from gce.tools.mimetypes import guess_mimetype

_logger = logging.getLogger(__name__)

class ir_attachment(osv.osv):
    """Attachments are used to link binary files or url to any gce document.
