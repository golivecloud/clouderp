...
import gce
from gce import SUPERUSER_ID, netsvc, api
from gce.osv import fields, osv
from gce.tools import DEFAULT_SERVER_DATETIME_FORMAT
from gce.tools.safe_eval import safe_eval as eval
from gce.tools.translate import _
from gce.modules import load_information_from_description_file
...
class ir_cron(osv.osv):
    ...
    def _callback(self, cr, uid, model_name, method_name, args, job_id):
        ...
        try:
            args = str2tuple(args)
            gce.modules.registry.RegistryManager.check_registry_signaling(cr.dbname)
            ...
            if model_name in registry:
                ...
                if hasattr(model, method_name):
                    ...
                    gce.modules.registry.RegistryManager.signal_caches_change(cr.dbname)
                else:
    ...
    def _acquire_job(cls, db_name):
        ...
        try:
            ...
            if e.pgcode == '42P01':
                ...
                # The table ir_cron does not exist; this is probably not an gce database.
