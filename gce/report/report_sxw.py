...
from gce.osv.fields import float as float_field, function as function_field, datetime as datetime_field
...
class rml_parse(object):
    def __init__(self, cr, uid, name, parents=rml_parents, tag=rml_tag, context=None):
        ...
        self.cr = cr
        self.uid = uid
        self.pool = gce.registry(cr.dbname)
...
class report_sxw(report_rml, preprocess.report):
    ...
    gce.netsvc.LocalService() indirection and the related
    gce.report.interface.report_int._reports dictionary:
    ...
    def getObjects(self, cr, uid, ids, context):
        table_obj = gce.registry(cr.dbname)[self.table]
