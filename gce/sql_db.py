...
"""
The PostgreSQL connector is a connectivity layer between the gce code and
...
class Cursor(object):
    """Represents an open transaction to the PostgreSQL DB backend,
       ...
       ``cursor`` objects.
        ...
        such as gce, we need the best guarantees that no data
        ...
        gce implements its own level of locking protection
        ...
        the default transaction isolation level for gce cursors, as
...
def close_db(db_name):
    """ You might want to call gce.modules.registry.RegistryManager.delete(db_name) along this function."""
    global _Pool
    if _Pool:
