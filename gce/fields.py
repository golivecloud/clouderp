...
from gce.sql_db import LazyCursor
from gce.tools import float_round, frozendict, html_sanitize, ustr, OrderedSet
from gce.tools import DEFAULT_SERVER_DATE_FORMAT as DATE_FORMAT
from gce.tools import DEFAULT_SERVER_DATETIME_FORMAT as DATETIME_FORMAT
from gce.tools.translate import html_translate
...
class Field(object):
    """ The field descriptor contains the field definition, and manages accesses
        ...
        recordset. The decorator :meth:`gce.api.depends` must be applied on
        ...
        is extended (see :class:`~gce.models.Model`), one can also extend
...
class Monetary(Field):
    ...
    def convert_to_cache(self, value, record, validate=True):
        ...
        # FIXME @rco-clouderp: currency may not be already initialized if it is a
