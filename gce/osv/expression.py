...
term representation was ['=', 'company_id.name', 'gce']. Used in a
...
gce will use the SQL function 'unaccent' when available for the
...
Finally, to instruct gce to really use the unaccent function, you have to
...
def get_unaccent_wrapper(cr):
    if gce.modules.registry.RegistryManager.get(cr.dbname).has_unaccent:
