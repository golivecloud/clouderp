...
import gce
from gce.modules import get_modules, get_module_path
...
class Command(object):
    """Subclass this class to define new gce subcommands """
...
def main():
    ...
    if len(args) > 1 and args[0].startswith('--addons-path=') and not args[1].startswith("-"):
        ...
        gce.tools.config._parse_config([args[0]])
        args = args[1:]
