...
from gce.modules.module import get_module_root, MANIFEST
from gce.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the clouderp server for your project"""
