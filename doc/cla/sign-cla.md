# Sign the clouderp CLA

In order for your contribution to clouderp to be accepted, you have to sign the
clouderp Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [clouderp/clouderp](/clouderp/clouderp), adding a new file `<github-login>.md` under the
...
3. An clouderp R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [clouderp/clouderp](/clouderp/clouderp), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is clouderp, the file would be
    `doc/cla/corporate/clouderp.md`. The file should contain:

    ```
<country>, <date>

<company-name> agrees to the terms of the clouderp Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `golive.pt`.  In that case someone from the clouderp team will
make the pull request on your behalf.

* Printable clouderp CCLA v1.0 https://www.golive.pt/files/legal/clouderp-CCLA-v1.0.pdf
* Printable clouderp ICLA v1.0 https://www.golive.pt/files/legal/clouderp-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for clouderp is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the clouderp project

* protect the clouderp project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the clouderp project and its users from bad actors who would contribute
...
contributor really intended to contribute to the clouderp project under specific
...
The clouderp CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, clouderp S.A. to use, modify and
...
(ICLA) of clouderp.  The agreement is executed by adding your name and
...
removed from the clouderp project.
