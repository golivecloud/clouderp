...
================
Security in clouderp
================

Aside from manually managing access using custom code, clouderp provides two main
...
An ORM :class:`~gce.fields.Field` can have a ``groups`` attribute
...
* restricted fields are removed from :meth:`~gce.models.Model.fields_get`
  responses
