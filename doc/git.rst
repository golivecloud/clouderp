...
Use the easy-setup shell script::
     ...
     curl -O https://raw.githubusercontent.com/clouderp/clouderp/master/clouderp.py | python2
...
* create your development branch with ``git checkout -b <branch_name>
  ...
  search in master you could use ``git checkout -b master-fts-xxx clouderp/master``
...
.. _the readme: https://github.com/golivecloud/clouderp/blob/master/README.md#migration-from-bazaar
