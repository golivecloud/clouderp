...
* Enter your clouderp Enterprise Subscription code
...
* Stop the clouderp service

  .. code-block:: console

    $ sudo service clouderp stop
...
* Update your database to the enterprise packages using
  ...
  .. code-block:: console
    ...
    $ python /usr/bin/clouderp.py -d <database_name> -u web --stop-after-init

* You should be able to connect to your clouderp Enterprise instance using your usual mean of identification.
  You can then link your database with your clouderp Enterprise Subscription by entering the code you received
...
* Restart your server with the updated addons path of point 3.
  ...
  clouderp Enterprise Subscription by entering the code you received by e-mail in the form input
...
* Uninstall clouderp Community (using the Uninstall executable in the installation folder) -
  PostgreSQL will remain installed

  .. image:: enterprise/windows_uninstall.png
    :class: img-responsive

* Launch the clouderp Enterprise Installer and follow the steps normally. When choosing
  ...
  Uncheck ``Start clouderp`` at the end of the installation

  .. image:: enterprise/windows_setup.png
   :class: img-responsive

* Using a command window, update your clouderp Database using this command (from the clouderp
  installation path, in the server subfolder)

  .. code-block:: console

    $ clouderp.exe -d <database_name> -u web --stop-after-init

* No need to manually launch the server, the service is running.
  You should be able to connect to your clouderp Enterprise instance using your usual
  mean of identification. You can then link your database with your clouderp Enterprise
