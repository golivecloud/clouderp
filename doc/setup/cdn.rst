...
Step 2: Configure the clouderp instance with your zone
--------------------------------------------------

In the clouderp back end, go to the :guilabel:`Website Settings`: menu, then
activate the CDN support and copy/paste your zone URL in the
:guilabel:`CDN Base URL` field.

.. image:: cdn/clouderp_cdn_base_url.png
   :class: img-responsive
...
.. image:: cdn/clouderp_check_your_html.png
   :class: img-responsive
...
resulting problem on a default clouderp website will be the lack of font-awesome
...
.. image:: cdn/clouderp_font_file_not_loaded.png
   :class: img-responsive

A security error message will also appear in the browser's console:

.. image:: cdn/clouderp_security_message.png
   :class: img-responsive
