define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // clouderp: allow access for override
    this.table = table;   // clouderp: allow access for override
    this.typing = typing; // clouderp: allow access for override
    this.bullet = bullet; // clouderp: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // clouderp: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // clouderp: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var className = linkInfo.className || null; // clouderp: addition
      ...
      var anchors = [];
      // clouderp: adding this branch to modify existing anchor
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', className); // clouderp: addition
        if (isNewWindow) {
