...
class MailChatController(gce.addons.bus.controllers.main.BusController):
    ...
    # --------------------------
    @gce.http.route('/mail/chat_post', type="json", auth="none")
    ...
    @gce.http.route(['/mail/chat_history'], type="json", auth="none")
    ...
    @gce.http.route('/mail/chat_init', type="json", auth="none")
