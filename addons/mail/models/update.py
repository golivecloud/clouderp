...
from gce import release, SUPERUSER_ID
from gce.models import AbstractModel
from gce.tools.translate import _
from gce.tools.config import config
...
class publisher_warranty_contract(AbstractModel):
    ...
    def update_notification(self, cr, uid, ids, cron_mode=True, context=None):
        """
        Send a message to gce's publisher warranty server to check the
