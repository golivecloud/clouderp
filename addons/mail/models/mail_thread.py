...
from gce import _, api, fields, models
from gce import exceptions
from gce import tools
from gce.addons.mail.models.mail_message import decode
...
class MailThread(models.AbstractModel):
    ...
    def message_route(self, message, message_dict, model=None, thread_id=None, custom_values=None):
        ...
        if ref_match:
            ...
            # do not match forwarded emails from another gce system (thread_id collision!)
    ...
    def _message_get_auto_subscribe_fields(self, updated_fields, auto_follow_fields=None):
        """ Returns the list of relational fields linking to res.users that should
            ...
            In gce V7, this is sufficent for all major addon such as opportunity,
