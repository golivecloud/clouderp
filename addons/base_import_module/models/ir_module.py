...
import gce
from gce import fields
from gce.osv import osv
from gce.tools import convert_file, exception_to_unicode
...
class ir_module_module(osv.osv):
    ...
    def import_module(self, cr, uid, module, path, force=False, context=None):
        ...
        terp = gce.modules.load_information_from_description_file(module, mod_path=path)
    ...
    def import_zipfile(self, cr, uid, module_file, force=False, context=None):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with gce.tools.osutil.tempdir() as module_dir:
