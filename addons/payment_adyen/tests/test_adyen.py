...
from gce.addons.payment_adyen.controllers.main import AdyenController
...
class AdyenForm(AdyenCommon):
    ...
    # @mute_logger('gce.addons.payment_adyen.models.adyen', 'ValidationError')
