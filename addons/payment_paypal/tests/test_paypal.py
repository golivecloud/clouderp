...
from gce.addons.payment.tests.common import PaymentAcquirerCommon
from gce.addons.payment_paypal.controllers.main import PaypalController
...
class PaypalCommon(PaymentAcquirerCommon):
    ...
    def setUp(self):
        ...
        # tde+seller@gce.com - tde+buyer@gce.com - tde+buyer-it@gce.com
...
class PaypalForm(PaypalCommon):
    ...
    def test_10_paypal_form_render(self):
        ...
        self.payment_acquirer.write(cr, uid, self.paypal_id, {'paypal_email_account': 'tde+paypal-facilitator@gce.com', 'fees_active': False}, context)
        ...
        form_values = {
            'cmd': '_xclick',
            'business': 'tde+paypal-facilitator@gce.com',
    ...
    @mute_logger('gce.addons.payment_paypal.models.paypal', 'ValidationError')
    def test_20_paypal_form_management(self):
        ...
        paypal_post_data = {
            ...
            'mc_currency': u'EUR',
            'shipping': u'0.00',
            'payer_email': u'tde+buyer@gce.com',
