...
class ImLivechatChannel(models.Model):
    """ Livechat Channel
        ...
        external website), 'script_internal' (code to be integrated with clouderp website) or via 'web_page' link.
    ...
    def _default_image(self):
        image_path = gce.modules.get_module_resource('im_livechat', 'static/src/img', 'default.png')
