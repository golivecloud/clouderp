...
from gce import tools, models, SUPERUSER_ID
from gce.osv import fields, osv
from gce.tools import float_is_zero
...
class pos_config(osv.osv):
    ...
    _columns = {
        ...
        'sequence_id' : fields.many2one('ir.sequence', 'Order IDs Sequence', readonly=True,
            help="This sequence is automatically created by clouderp but you can change it "\
