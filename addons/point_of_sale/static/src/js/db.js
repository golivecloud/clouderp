clouderp.define('point_of_sale.DB', function (require) {
"use strict";
...
var PosDB = core.Class.extend({
    name: 'gce_pos_db', //the prefix of the localstorage data
     ...
     * returned by the gce server. Categories must be inserted before the products or the 
