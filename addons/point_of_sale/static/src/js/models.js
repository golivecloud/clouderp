clouderp.define('point_of_sale.models', function (require) {
"use strict";
...
//
// models: [{
//  model: [string] the name of the gce model to load.
...
//  context: [Dict|function] the gce context for the model read
