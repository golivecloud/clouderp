...
from gce.exceptions import RedirectWarning, UserError
from gce.tools.misc import formatLang
from gce.tools import float_compare, float_is_zero
...
class AccountMoveLine(models.Model):
    ...
    def create(self, vals, apply_taxes=True):
        ...
        if apply_taxes and not context.get('dont_create_taxes') and vals.get('tax_ids'):
            # Get ids from triplets : https://www.golive.pt/documentation/master/reference/orm.html#gce.models.Model.write
