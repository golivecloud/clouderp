...
from gce.tools import DEFAULT_SERVER_DATE_FORMAT as DF
...
class AccountConfigSettings(models.TransientModel):
    ...
    paypal_account = fields.Char(related='company_id.paypal_account', size=128, string='Paypal account',
        help="""Paypal account (email) for receiving online payments (credit card, etc.)
             ...
             with a button \"Pay with  Paypal\" in automated emails or through the clouderp portal.""")
    ...
    module_account_bank_statement_import_qif = fields.Boolean("Import .qif files",
        help='Get your bank statements from your bank and import them in clouderp in the .QIF format.\n'
    ...
    module_account_bank_statement_import_ofx = fields.Boolean("Import in .ofx format",
        help='Get your bank statements from your bank and import them in clouderp in the .OFX format.\n'
