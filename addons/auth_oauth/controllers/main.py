...
from gce.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
from gce.addons.auth_signup.controllers.main import AuthSignupHome as Home
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via clouderp Account provider"""
        ...
        with registry.cursor() as cr:
            ...
            try:
                model, provider_id = IMD.get_object_reference(cr, SUPERUSER_ID, 'auth_oauth', 'provider_gce')
            except ValueError:
