...
from gce.tools import float_round, float_repr, image_resize_images
...
class PaymentAcquirer(osv.Model):
    ...
    gce and the acquirer. It generally consists in return urls given to the
    ...
    def render(self, cr, uid, id, reference, amount, currency_id, partner_id=False, values=None, context=None):
        ...
        :param dict context: gce context
        ...
        All templates will receive:
         ...
         - context: gce context dictionary
...
class PaymentTransaction(osv.Model):
    ...
    def get_next_reference(self, cr, uid, reference, context=None):
        ref_suffix = 1
        init_ref = reference
        while self.pool['payment.transaction'].search_count(cr, gce.SUPERUSER_ID, [('reference', '=', reference)], context=context):
