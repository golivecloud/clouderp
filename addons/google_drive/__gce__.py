...

{
    ...
    'description': """
Integrate google document to gce record.
============================================

This module allows you to integrate google documents to any of your gce record quickly and easily using OAuth 2.0 for Installed Applications,
