clouderp.define('survey.tour_test_survey', function (require) {
'use strict';
...
Tour.register({
    ...
    steps: [
        ...
        // Page-2
        // Question: What do you think about the documentation available on doc.golive.pt?
        {
        ...
        {
            title:     "For 'I use the contextual help in clouderp' checking 'Agree'",
        ...
        // Question: What do you think about the process views of clouderp, available in the web client ?
        {
            title:     "For 'They help new users to understand clouderp' checking 'Totally disagree'",
        ...
        // Page-3
        // Question: How do you contribute or plan to contribute to clouderp?
        {
