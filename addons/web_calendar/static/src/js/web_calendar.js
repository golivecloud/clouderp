clouderp.define('web_calendar.CalendarView', function (require) {
"use strict";
/*---------------------------------------------------------
 * gce web_calendar
 *---------------------------------------------------------*/
...
var CalendarView = View.extend({
    ...
    /**
     * Refresh one fullcalendar event identified by it's 'id' by reading gce record state.
    ...
    /**
     * Transform gce event object to fullcalendar event object
     */
    ...
    /**
     * Transform fullcalendar event object to gce Data object
     */
    ...
    /**
     * Build gce Domain to filter object by this.date_start field
