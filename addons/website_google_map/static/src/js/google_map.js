function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('clouderp-google-map'), {
        zoom: 1,
    ...
    if (clouderp_partner_data){ /* clouderp_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < clouderp_partner_data.counter; i++) {
            set_marker(clouderp_partner_data.partners[i]);
        }
