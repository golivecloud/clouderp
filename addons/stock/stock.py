                ...
                if product_qty < move['product_qty']:
                    warning.update({
                        ...
                        'message': _("By changing this quantity here, you accept the "
                                "new quantity as complete: clouderp will not "
...
from gce.report import report_sxw
...
class stock_warehouse_orderpoint(osv.osv):
    ...
    _columns = {
        ...
        'product_min_qty': fields.float('Minimum Quantity', required=True,
            ...
            help="When the virtual stock goes below the Min Quantity specified for this field, clouderp generates "\
            "a procurement to bring the forecasted quantity to the Max Quantity."),
        'product_max_qty': fields.float('Maximum Quantity', required=True,
            digits_compute=dp.get_precision('Product Unit of Measure'),
            help="When the virtual stock goes below the Min Quantity, clouderp generates "\
