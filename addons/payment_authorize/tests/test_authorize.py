...
from gce.addons.payment_authorize.controllers.main import AuthorizeController
from gce.tools import mute_logger


@gce.tests.common.at_install(True)
...
class AuthorizeForm(AuthorizeCommon):
    ...
    @mute_logger('gce.addons.payment_authorize.models.authorize', 'ValidationError')
