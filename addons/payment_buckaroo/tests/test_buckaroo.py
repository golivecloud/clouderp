...
from gce.addons.payment_buckaroo.controllers.main import BuckarooController
from gce.tools import mute_logger


@gce.tests.common.at_install(False)
@gce.tests.common.post_install(False)
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('gce.addons.payment_buckaroo.models.buckaroo', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@gce.com',
