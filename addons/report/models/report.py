...
from gce.sql_db import TestCursor
...
#--------------------------------------------------------------------------
# Check the presence of Wkhtmltopdf and return its version at clouderp start-up
#--------------------------------------------------------------------------
...
try:
    ...
    if config['workers'] == 1:
        _logger.info('You need to start clouderp with at least two workers to print a pdf version of the reports.')
