...
import gce
from gce import api, tools, SUPERUSER_ID
from gce.osv import osv, fields, expression
from gce.tools.translate import _
from gce.tools import DEFAULT_SERVER_DATETIME_FORMAT, DEFAULT_SERVER_DATE_FORMAT
import psycopg2

import gce.addons.decimal_precision as dp
from gce.tools.float_utils import float_round, float_compare
    ...
    def create_variant_ids(self, cr, uid, ids, context=None):
        ...
        for tmpl_id in tmpl_ids:
            ...
            for variant_id in map(int,variants_inactive):
                try:
                    with cr.savepoint(), tools.mute_logger('gce.sql_db'):
