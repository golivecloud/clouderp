clouderp.define('web.ControlPanelMixin', function (require) {
"use strict";
...
clouderp.define('web.ControlPanel', function (require) {
"use strict";
...
var ControlPanel = Widget.extend({
     ...
     * @param {gce.web.SearchView} [status.searchview] the searchview widget
     ...
     * @param {gce.web.SearchView} [searchview] the searchview Widget
