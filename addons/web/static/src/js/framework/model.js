clouderp.define('web.Model', function (require) {
"use strict";
...
var Model = Class.extend({
    /**
    new gce.web.Model([session,] model_name[, context[, domain]])

    @constructs instance.web.Model
    @extends instance.web.Class

    @param {gce.web.Session} [session] The session object used to communicate with
    the server.
    @param {String} model_name name of the gce model this object is bound to
    ...
    */
    ...
    /**
     * Call a method (over RPC) on the bound gce model.
     *
    ...
    /**
     * Executes a signal on the designated workflow, on the bound gce model
     *
