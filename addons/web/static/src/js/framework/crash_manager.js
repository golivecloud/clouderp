clouderp.define('web.crash_manager', function (require) {
    var CrashManager = require('web.CrashManager');
    return new CrashManager();
});

clouderp.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = core.Class.extend({
    ...
    rpc_error: function(error) {
        ...
        if (error.data.name === "gce.http.SessionExpiredException" || error.data.name === "werkzeug.exceptions.Forbidden") {
            this.show_warning({type: "Session Expired", data: { message: _t("Your clouderp session expired. Please refresh the current web page.") }});
            return;
        }
    ...
    show_warning: function(error) {
        ...
        new Dialog(this, {
            size: 'medium',
            title: "clouderp " + (_.str.capitalize(error.type) || _t("Warning")),
    ...
    show_error: function(error) {
        ...
        new Dialog(this, {
            title: "clouderp " + _.str.capitalize(error.type),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: "clouderp " + (_.str.capitalize(error.type) || "Warning"),
            buttons: [
...
core.crash_registry.add('gce.exceptions.RedirectWarning', RedirectWarningHandler);
