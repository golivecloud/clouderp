clouderp.define('web.mixins', function (require) {
"use strict";
...
function clouderpEvent (target, name, data) {
    this.target = target;
    this.name = name;
...
clouderpEvent.prototype.stop_propagation = function () {
    this.stopped = true;
};

clouderpEvent.prototype.is_stopped = function () {
    return this.stopped;
};
...
var EventDispatcherMixin = _.extend({}, ParentedMixin, {
    ...
    trigger_up: function(name, info) {
        var event = new clouderpEvent(this, name, info);
