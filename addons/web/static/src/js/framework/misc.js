clouderp.define('web.framework', function (require) {
"use strict";
...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<div class="gce oe_blockui_spin_container" style="background-color: transparent;">';
...
//  * If params.wait, reload will wait the gce server to be reachable before reloading
...
$.fn.gceClass = function(additionalClass) {
    // This plugin should be applied on top level elements
    additionalClass = additionalClass || '';
    if (!!$.browser.msie) {
        additionalClass += ' gce_ie';
    }
    return this.each(function() {
        $(this).addClass('gce ' + additionalClass);
    });
};
$.fn.gceBounce = function() {
    return this.each(function() {
...
clouderp.define('web.IFrameWidget', function (require) {
"use strict";
