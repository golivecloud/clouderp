clouderp.define('web.Widget', function (require) {
"use strict";
 ...
 *
 * MyWidget = gce.base.Widget.extend({
...
var Widget = core.Class.extend(mixins.PropertiesMixin, {
     ...
     *
     * @constructs gce.Widget
     *
     * @param {gce.Widget} parent Binds the current instance to the given Widget instance.
     ...
     * gce Web where developers may want to replace existing callbacks with
     * theirs.
     *
