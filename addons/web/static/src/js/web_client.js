clouderp.define('web.WebClient', function (require) {
"use strict";
...
var WebClient = Widget.extend({
    ...
    init: function(parent, client_options) {
        ...
        this.set('title_part', {"zgce": "clouderp"});
    },
    start: function() {
        var self = this;
    ...
    show_common: function() {
        ...
        self.notification_manager.appendTo(self.$('.gce'));
        self.loading = new Loading(self);
        self.loading.appendTo(self.$('.gce_webclient_container'));
