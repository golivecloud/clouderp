clouderp.define('web.form_widgets', function (require) {
"use strict";
    ...
    render_value: function(){
        ...
        if(this.check_timezone()){
            ...
            var options = _.extend({
                ...
                title: _t("Timezone Mismatch : The timezone of your browser doesn't match the selected one. The time in clouderp is displayed according to your field timezone."),
            });
...
var FieldStatus = common.AbstractField.extend({
    ...
    /*
     * :deprecated: this feature will probably be removed with gce v8
     */
...
var AbstractFieldUpgrade = {
    ...
    open_dialog: function() {
        ...
        return new Dialog(this, {
            ...
            title: _t("clouderp Enterprise"),
        }).open();
    },
  
    confirm_upgrade: function() {
        new Model("res.users").call("search_count", [[["share", "=", false]]]).then(function(data) {
            framework.redirect("https://www.golive.pt/clouderp-enterprise/upgrade?num_users=" + data);
        });
    },
 ...
 * will substitute to the <field> tags as defined in gce's views.
 */
 ...
 * tags defined in gce's form views.
 *
