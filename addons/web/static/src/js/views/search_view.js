clouderp.define('web.SearchView', function (require) {
"use strict";
...
var SearchView = Widget.extend(/** @lends instance.web.SearchView# */{
    ...
    /**
     * @param {gce.web.search.SearchQuery | undefined} Undefined if event is change
     * @param {gce.web.search.Facet}
     * @param {Object} [options]
     */
...
clouderp.define('web.AutoComplete', function (require) {
"use strict";
