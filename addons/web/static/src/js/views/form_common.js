clouderp.define('web.form_common', function (require) {
"use strict";
 ...
 *     This event is not related to the on_change mechanism of gce and is always called
...
var FieldManagerMixin = {
    ...
    */
    ...
    /**
    Computes an gce domain.

    @param {Array} expression An gce domain.
    ...
    */
    ...
    @return {CompoundContext} An gce context.
    */
...
var FieldInterface = {
     ...
     * osv class in the gce server as well as the syntax used by the set_value() (see below). It must
     ...
     * the gce server, although it is not assumed to respect the constraints applied to the field.
...
var AbstractField = FormWidget.extend(FieldInterface, {
    ...
    */
     ...
     * value is similar to false in gce.
     */
    is_false: function() {
