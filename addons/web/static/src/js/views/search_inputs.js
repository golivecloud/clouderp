clouderp.define('web.search_inputs', function (require) {
"use strict";
...
/**
 * Implementation of the ``char`` gce field type:
 *
...
/**
 * Implementation of the ``datetime`` gce field type:
 *
...
var FilterGroup = Input.extend(/** @lends instance.web.search.FilterGroup# */{
     ...
     *
     * @param {gce.web.search.Facet} facet
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the gce filters (button with a context and/or
