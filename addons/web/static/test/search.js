clouderp.define_section('search.query', ['web.SearchView'], function (test) {
...
clouderp.define_section('search.defaults', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
...
clouderp.define_section('search.completions', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
    ...
    test('facet selection', function (assert) {
        ...
        var completion = {
            ...
            facet: {
                field: {
                    get_domain: clouderp.testing.noop,
                    get_context: clouderp.testing.noop,
                    get_groupby: clouderp.testing.noop
                },
                category: 'Dummy',
                values: [{label: 'dummy', value: 42}]
            }
...
clouderp.define_section('search.serialization', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
...
clouderp.define_section('search.filters', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
    function setup () {
        mock.add('dummy.model:fields_view_get', function () {
...
clouderp.define_section('search.groupby', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
...
clouderp.define_section('search.filters.saved', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
...
clouderp.define_section('search.advanced', ['web.search_inputs', 'web.SearchView', 'web.core', 'web.data'], function (test, mock) {
