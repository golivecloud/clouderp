...
clouderp.define('web_analytics.web_analytics', function (require) {
"use strict";
...
*  web_client.do_push_state() method which is responsible of changing the gce current url
*/
...
var Tracker = core.Class.extend({
    ...
    */
    init: function(webclient) {
        ...
        _gaq.push(['_setDomainName', '.gce.com']);  // Allow multi-domain
    ...
    */
    on_state_pushed: function(state) {
        // Track only pages corresponding to a 'normal' view of gce, views
