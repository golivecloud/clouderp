...
import gce
import gce.addons.hw_proxy.controllers.main as hw_proxy
import threading
import subprocess
...
<html>
    <head>
        <title>clouderp's PosBox - Software Upgrade</title>
	...
	<p></p>
        ...
        the <a href='http://nightly.golive.pt/trunk/posbox/'>latest image</a>. The upgrade
        procedure is explained into to the
        <a href='https://www.golive.pt/documentation/user/point_of_sale/posbox/index.html'>PosBox manual</a>
        </p>
        <p>
        ...
        <pre>
"""
upgrade_template += subprocess.check_output("git --work-tree=/home/pi/clouderp/ --git-dir=/home/pi/clouderp/.git log -1", shell=True).replace("\n", "<br/>")
upgrade_template += """
        </pre>
        <div class='centering'>
...
class PosboxUpgrader(hw_proxy.Proxy):
    ...
    def perform_upgrade(self):
        ...
        os.system('/home/pi/clouderp/addons/point_of_sale/tools/posbox/configuration/posbox_update.sh')
