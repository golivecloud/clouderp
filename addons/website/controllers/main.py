...
import gce
from gce.addons.base.ir.ir_qweb import AssetsBundle
from gce.addons.web.controllers.main import WebClient, Binary
...
class Website(gce.addons.web.controllers.main.Home):
    #------------------------------------------------------
    # View
    #------------------------------------------------------
    ...
    def sitemap_xml_index(self):
        cr, uid, context = request.cr, gce.SUPERUSER_ID, request.context
    ...
    def website_info(self):
        ...
        values = {
            'apps': apps,
            'modules': modules,
            'version': gce.service.common.exp_version()
        }
...
#------------------------------------------------------
class WebsiteBinary(gce.http.Controller):
    @http.route([
        '/website/image',
        '/website/image/<xmlid>',
